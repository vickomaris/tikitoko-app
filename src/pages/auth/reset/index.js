...
const Reset = () => {
  return (
    <section className={`${styles['auth-section']}`}>
        ...
        <p className='flex d-flex justify-content-center fw-bold mt-2'>Reset Password</p>
        ...
        <form>
          ...
          <p>Don't have a Tokopedia account? <button className={`${styles['button-register-now']}`}>Register</button></p>
          </div>
          </div>
        </form>
    </section>
